...
nytg.budget_array_data = [{
    ...
    "name": "Exhibit Design - SF Exploratorium",
    "positions": {
        "total": {
            "x": 570,
            "y": 340
    ...
    "name": "Redesign New York's Education System, ASB",
    "positions": {
        "total": {
            "x": 360,
            "y": 437
    ...
    "name": "Publications - Scholastic Best of Teen Writing 2008",
    "positions": {
        "total": {
            "x": 654,
            "y": 266
    ...
    "name": "Publications - Scholastic Best of Teen Writing 2010",
    "positions": {
        "total": {
            "x": 634,
            "y": 299
    ...
    "name": "Publications - The Provo Orem Word",
    "positions": {
        "total": {
            "x": 325,
            "y": 265
    ...
    "name": "Editor, Walden Lit Journal",
    "positions": {
        "total": {
            "x": 671,
            "y": 333
    ...
    "id": 327,
    "budget_2012": -347000,
    "change": 0.144092219020173,
    "budget_2013": 35200000,
    ...
    "name": "Arts Grant - SPARK, Stanford",
    "positions": {
        "total": {
            "x": 653,
            "y": 323
    ...
    "name": "Resident Computer Consultant",
    "positions": {
        "total": {
            "x": 9641,
            "y": 5
    ...
    "id": 260,
    "budget_2012": 988000,
    "change": 0.597165991902834,
    "budget_2013": 10470000,
    "department": "Classes",
    "discretion": "Technical"
}, {
    "name": "Design for Exploration",
    "positions": {
        "total": {
            "x": 329,
            "y": 161
    ...
    "name": "Scholastic Gold Portfolio",
    "positions": {
        "total": {
            "x": 660,
            "y": 193
    ...
    "name": "Best of Teen Writing, 2008",
    "positions": {
        "total": {
            "x": 432,
            "y": 101
    ...
    "name": "Best of Teen Writing, 2010",
    "positions": {
        "total": {
            "x": 432,
            "y": 101
    ...
    "name": "Education - Stanford University",
    "positions": {
        "total": {
            "x": 356,
            "y": 408
    ...
    "name": "Education - Colegio Imaculada Conceicao",
    "positions": {
        "total": {
            "x": 35227,
            "y": 207
    ...
    "name": "Education - The Walden School of Liberal Arts",
    "positions": {
        "total": {
            "x": 607,
            "y": 406
    ...
    "change": -0.146399264372097,
    "budget_2013": 35123000,
    "department": "Travel",
    "discretion": "Creative"
}, {
    "name": "Travel - Belgium",
    ...
    "name": "Study Abroad - British Politics",
    "positions": {
        "total": {
            "x": 502,
            "y": 357
    ...
    "name": "Translation, GoPro World Cup Commerical",
    "positions": {
        "total": {
            "x": 503,
            "y": 299
    ...
    "name": "Study Abroad - British Mystery Novels",
    "positions": {
        "total": {
            "x": 322,
            "y": 393
    ...
    "name": "Study Abroad - British Literature",
    "positions": {
        "total": {
            "x": 668,
            "y": 207
    ...
    "name": "Volunteering - Rose Education Foundation",
    "positions": {
        "total": {
            "x": 518,
            "y": 481
    ...
    "name": "Volunteering - Casita Linda",
    "positions": {
        "total": {
            "x": 395,
            "y": 466
    ...
    "name": "Volunteering - Oaxaca Street Children Foundation",
    "positions": {
        "total": {
            "x": 488,
            "y": 467
    ...
    "name": "Foreign Correspondent, San Jose Mercury News",
    "positions": {
        "total": {
            "x": 456,
            "y": 367
    ...
    "name": "Foreign Correspondent, Denver Post",
    "positions": {
        "total": {
            "x": 528,
            "y": 371
    ...
    "name": "Foreign Correspondent, Oakland Tribune",
    "positions": {
        "total": {
            "x": 333,
            "y": 266
    ...
    "name": "Scholastic Portfolio Award Winner",
    "positions": {
        "total": {
            "x": 642,
            "y": 407
    ...
    "name": "Foreign Correspondent, Salt Lake Tribune",
    "positions": {
        "total": {
            "x": 446,
            "y": 286
    ...
    "name": "Teaching Assistant, Parks and Peoples",
    "positions": {
        "total": {
            "x": 501,
            "y": 378
    ...
    "id": 458,
    "budget_2012": 1654000,
    "change": 0.846432889963724,
    "budget_2013": 1640000,
    "department": "Employment",
    "discretion": "Creative"
}, {
    "name": "Human Computer Interaction Course Advisor",
    "positions": {
        "total": {
            "x": 658,
            "y": 248
...
nytg.category_list = ["Art", "Languages", "Programming Languages", "Sports", "Something", "Education", "Employment", "Publications", "Circus", "Writing", "Design", "Grants", "Classes", "Travel", "Computer Science", "Technologies"];
nytg.category_data = [{
    "label": "Art",
    "total": 921605000,
    "num_children": 26,
    ...
    "total": 31608000,
    "num_children": 8,
    "short_label": "Languages"
}, {
    "label": "Programming Languages",
    "total": 7502000,
    "num_children": 13,
    "short_label": "Programming Languages"
}, {
    "label": "Sports",
    "total": 37399000,
    "num_children": 16,
    ...
    "total": 44010000,
    "num_children": 14,
    "short_label": "Computer Science"
}, {
    "label": "Technologies",
    "total": 885315000,
    "num_children": 2,
    "short_label": "Technologies"
}]; 
    /********************************
...
nytg.formatNumber = function(n, decimals) {
    ...
    if (decimals > 0) {
        ...
        return num.replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "1,") + suffix;
    } else {
...
nytg.Chart = function() {
    return {
        ...
        init: function() {
            ...
            d3.select("#nytg-CreativeOverlay").append("div")
                .html("<p></p>")
                .style("top", this.changeScale(0) + 'px')
                .classed('nytg-CreativeTick', true)
                .classed('nytg-CreativeZeroTick', true)
            d3.select("#nytg-CreativeOverlay").append("div")
                .style("top", this.changeScale(100) + 'px')
                .classed('nytg-CreativeTickLabel', true)
            d3.select("#nytg-CreativeOverlay").append("div")
                .style("top", this.changeScale(-100) + 'px')
                .classed('nytg-CreativeTickLabel', true)
            ...
            for (var i = 0; i < nytg.category_data.length; i++) {
                ...
                var catTot = this.bigFormat(nytg.category_data[i]['total']) //TODO category stuff
        ...
        TechnicalLayout: function() {
            ...
            this.force
                ...
                .on("tick", function(e) {
                    that.circle
                        .each(that.TechnicalSort(e.alpha))
                        .each(that.buoyancy(e.alpha))
                        .attr("cx", function(d) {
                            return d.x;
                        })
        ...
        CreativeLayout: function() {
            ...
            this.force
                ...
                .on("tick", function(e) {
                    that.circle
                        .each(that.CreativeSort(e.alpha))
                        .attr("cx", function(d) {
                            return d.x;
                        })
                        .attr("cy", function(d) {
        ...
        TechnicalSort: function(alpha) {
            ...
            return function(d) {
                ...
                if (d.discretion === that.Creative) {
                    targetX = 550
                } else if ((d.discretion === that.Technical) || (d.discretion === that.NET_INTEREST)) {
                    targetX = 400
                } else {
                    targetX = 900
                };
        ...
        CreativeSort: function(alpha) {
            ...
            return function(d) {
                ...
                } else if ((d.discretion === "Technical")) {
...
nytg.ready = function() {
    ...
    function onMainChange(evt) {
        ...
        if (tabIndex === 0) {
            ...
            nytg.c.TechnicalLayout();
            this.currentOverlay = $j("#nytg-TechnicalOverlay");
            this.currentOverlay.delay(300).fadeIn(500);
            $j("#nytg-chartFrame").css({
                'height': 550
            });
        } else if (tabIndex === 2) {
            nytg.c.CreativeLayout();
            this.currentOverlay = $j("#nytg-CreativeOverlay");
            this.currentOverlay.delay(300).fadeIn(500);
            $j("#nytg-chartFrame").css({
                'height': 650
            });
